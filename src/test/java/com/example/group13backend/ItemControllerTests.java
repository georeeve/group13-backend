...
public class ItemControllerTests {
  ...
  public ItemControllerTests(
      ItemController itemController, TestRestTemplate restTemplate, TestUtil testUtil) {
  ...
  public void getItems() throws JsonProcessingException {
    ...
    final var response =
        restTemplate.exchange(
            testUtil.getEndpoint("/items", port), HttpMethod.GET, HttpEntity.EMPTY, String.class);
  ...
  public void getItem() throws JsonProcessingException {
    ...
    final var response =
        restTemplate.exchange(
            testUtil.getEndpoint("/items/1", port), HttpMethod.GET, HttpEntity.EMPTY, String.class);
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
